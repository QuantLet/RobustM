...
df = "SP100"#"Russell3000"
load("SP100.RData")
#load("Russell3000.RData")

#Choose the starting point of analysis  
start_point = "2000-01-01" #for the Russell3000 dataset
myData = switch(df,
                "SP100" = SP100,
...
path_to_python = ""#define the path to Python
Sys.which("python")
...
my_colors = RColorBrewer::brewer.pal(7,"Set1")[c(1:5,7)]
